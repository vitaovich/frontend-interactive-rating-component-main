...
```bash
az staticwebapp create -n StarterNextJSTailwindCSS -g StarterNextJS -s https://github.com/<YOUR_GITHUB_USERNAME>/frontend-interactive-rating-component-main -l WestUs2 -b main --login-with-github
```
...
```bash 
https://github.com/<YOUR_GITHUB_USERNAME>/frontend-interactive-rating-component-main/actions
```
...
``` bash
sed -i "s/frontend-interactive-rating-component-main/<your project name>/" package.json package-lock.json README.md
chmod u+x setup.sh
```
